  ...
  <header id="header" class="header d-flex align-items-center position-relative">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <img src="{{ asset('img/logo2.png') }}" alt="AgriCulture">
        <!-- <h1 class="sitename">AgriCulture</h1>  -->
      </a>

      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="landing.master" class="active">Home</a></li>
          <li><a href="landing.about">About Us</a></li>
          <li><a href="landing.service">Our Services</a></li>
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
          <ol>
            <li><a href="landing.master">Home</a></li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 mb-4 mb-lg-0">
              <img src="{{ asset('img/img_long_5.jpeg') }}" alt="Image " class="img-fluid img-overlap" data-aos="zoom-out">
            </div>
            <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <h3 class="content-subtitle text-white opacity-50"> Pemilik Lembaga</h3>
              ...
              <div class="row my-5">
                <div class="col-lg-12 d-flex align-items-start mb-4">                 
                  <div>
                    <h4 class="m-0 h5 text-white">Visi</h4>
                    <p class="text-white opacity-50">Terwujudnya masyarakat yang makmur, sejahtera, cerdas, terampil, dan berdaya saing tinggi serta bertakwa kepada Tuhan Yang Maha Esa.</p>
                  </div>
                </div>
                <div class="col-lg-12 d-flex align-items-start mb-4">
                  <div>
                    <h4 class="m-0 h5 text-white">Misi</h4>
                    <p class="text-white opacity-50">Membina dan mengembangkan sumberdaya manusia melalui pelayanan sosial dan ekonomi untuk kesejahteraan masyaraka</p>
                    <p class="text-white opacity-50">Menyelenggarakan pelatihan-pelatihan demi meninggkatkan pengetahuan dan keterampilan untuk yang berkompetensi dan berdaya saing tinggi</p>
                    <p class="text-white opacity-50">Mengkaji dan menggembangkan sumberdaya alam lahan keringkepulauan untuk meninggkatkan kemakmuran dan kesejahteraanmasyarakat</p>
                    <p class="text-white opacity-50">Membina dan menggembangkan kepribadian yang bertakwakepada tuhan Yang Maha Esa</p>
